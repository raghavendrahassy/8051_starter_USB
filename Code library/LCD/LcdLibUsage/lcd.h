 ...
 ***************************************************************************************************/
#define M_LcdDataBus P1
#define M_LcdDataBusDirection P1
#define M_LcdDataBusInput P1

#define M_LcdControlBus P1
#define M_LcdControlBusDirection P1
...
#define LCD_RS  0
#define LCD_RW  1  /* Comment this line if RW pin is not used(grounded on the board) */
#define LCD_EN  2
/**************************************************************************************************/
...
#define    Enable_LCD_DisplayDecimalNumber   1
#define    Enable_LCD_DisplayHexNumber       1
#define    Enable_LCD_DisplayBinaryNumber    1
